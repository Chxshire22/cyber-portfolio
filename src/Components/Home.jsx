...
export default function Home() {
	...
	let clickAudio = new Audio("../../public/click-47609.mp3")
	...
	return (
		<main>
					...
					<article className="carousel__content">
						...
						<div className="carousel__content-linknav">
							<div className="carousel-link">
								<a id="github-repo-link" href={currentProject.githubRepo} target="_blank" >
									<p>Github Repo {" "}<FontAwesomeIcon icon={faArrowUpRightFromSquare} /> </p>
								</a>
								<a id="deployment-link" href={currentProject.deployment} target="_blank">
									<p>Deployment{" "}<FontAwesomeIcon icon={faArrowUpRightFromSquare} /></p>
								</a>
							</div>
							<FontAwesomeIcon
								icon={faArrowLeft}
			...
			<section className="block" id="url">
				...
				<div className="block-content">
					<p id="copy-url">
						https://indransari.com <FontAwesomeIcon icon={faCopy} />
					</p>
				</div>
			</section>
		</main>
